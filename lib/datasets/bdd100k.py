...
class bdd100k(imdb):
    def __init__(self, image_set, devkit_path=None):
        ...
        self._devkit_path = cfg_d.BDD100K 
        self._data_path = os.path.join(self._devkit_path)
        # self._classes = ('__background__',  # always index 0
        #          'car') # for testing after training on sim10k
        self._classes = ('__background__',  # always index 0
                         'bus', 'bicycle', 'car', 'motorcycle', 'person', \
                         'rider', 'train', 'truck')
    ...
    def _get_voc_results_file_template(self):
        ...
        filedir = os.path.join(self._devkit_path, 'results', 'bdd100k', 'Main')
